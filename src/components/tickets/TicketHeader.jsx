export default function TicketHeader() {
  return (
    <div className="flex items-center justify-between border border-primary rounded-lg py-3 md:py-3 px-3 md:px-5 bg-gray-50 font-semibold text-[10px] md:text-xs text-gray-700">
