        ...
        <Table className="table-fixed text-sm md:text-[11px]">
          <TableHeader className="bg-gray-50">
            <TableRow className="hover:bg-gray-50">
              ...
              <TableHead className="text-gray-700 font-semibold px-2 py-1.5 md:py-0.5 w-[500px]">
                User
              </TableHead>
              <TableHead className="text-gray-700 font-semibold hidden md:table-cell px-2 py-1.5">
                Username
              </TableHead>
              <TableHead className="text-gray-700 font-semibold text-start w-[100px] px-2 py-1.5 md:py-0.5">
                Role
              </TableHead>
              <TableHead className="text-gray-700 font-semibold text-start w-[100px] px-2 py-1.5 md:py-0.5">
                Actions
          ...
          <TableBody>
            {users.map((user) => (
              <TableRow key={user?.id} className="cursor-pointer md:py-8">
                ...
                <TableCell className="font-semibold text-gray-700 px-2 py-2.5 flex items-center gap-4 ">
